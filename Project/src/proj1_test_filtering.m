...
%% Setup
chdir_src2input();
test_image = im2single(imread('cat.bmp'));
chdir_src();
...
chdir_output();
imwrite(identity_image, 'test1_identity_image.jpg', 'quality', 95);
chdir_src();
...
imwrite(blur_image, 'test2_blur_image.jpg', 'quality', 95);
chdir_src();
...
imwrite(large_blur_image, 'test3_large_blur_image.jpg', 'quality', 95);
chdir_src();
...
imwrite(sobel_image + 0.5, 'test4_sobel_image.jpg', 'quality', 95);
chdir_src();
...
imwrite(laplacian_image + 0.5, 'test5_laplacian_image.jpg', 'quality', 95);
chdir_src();
...
imwrite(high_pass_image + 0.5, 'test6_high_pass_image.jpg', 'quality', 95);
chdir_src();
%by James Hays