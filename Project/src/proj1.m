...
image2 = im2single(imread('cat.bmp'));
chdir_src();
...
figure(3); imshow(vis);
chdir_output();
imwrite(low_frequencies, '1_low_frequencies.jpg', 'quality', 95);
imwrite(high_frequencies + 0.5, '2_high_frequencies.jpg', 'quality', 95);
imwrite(hybrid_image, '3_hybrid_image.jpg', 'quality', 95);
imwrite(vis, '4_hybrid_image_scales.jpg', 'quality', 95);
chdir_src();